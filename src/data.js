...
const MANUAL_DESCRIPTIONS = {
    ...
    "6270": { // The Walking Dead
        en: "The Walking Dead is a five-part game series set in the same universe as Robert Kirkman's award-winning comic book series. Play as Lee Everett, a convicted criminal, who has been given a second chance at life in a world devastated by the undead.",
        es: "The Walking Dead es una serie de juegos de cinco partes ambientada en el mismo universo que la galardonada serie de cómics de Robert Kirkman. Juega como Lee Everett, un criminal convicto al que se le ha dado una segunda oportunidad en un mundo devastado por los muertos vivientes."
    },
    "58175": { // God of War (2018)
        en: "His vengeance against the Gods of Olympus years behind him, Kratos now lives as a man in the realm of fresh Deities and monsters. It is in this harsh, unforgiving world that he must fight to survive… and teach his son to do the same.",
        es: "Años después de su venganza contra los Dioses del Olimpo, Kratos vive ahora como un hombre en el reino de las deidades y los monstruos nórdicos. Es en este mundo duro e implacable donde debe luchar para sobrevivir... y enseñar a su hijo a hacer lo mismo."
    },
    "22509": { // Minecraft
...
const GAMES_DATA = [
    ...
    },
    {
        ...
        description: {
            en: "An acclaimed remake of the survival horror masterpiece. James Sunderland receives a letter from his deceased wife, leading him to the town of Silent Hill, where he must face his own inner demons.",
            es: "Un aclamado remake de la obra maestra del survival horror. James Sunderland recibe una carta de su difunta esposa, lo que lo lleva al pueblo de Silent Hill, donde deberá enfrentarse a sus propios demonios internos."
        },
        detailedHistory: {
            en: "Developed by Bloober Team in collaboration with original members of Team Silent, this remake brings the psychological depth and atmosphere of the 2001 classic to modern platforms with enhanced graphics, sound design, and gameplay. It remains faithful to the complex narrative that made the original a genre-defining title.",
            es: "Desarrollado por Bloober Team en colaboración con miembros originales de Team Silent, este remake traslada la profundidad psicológica y la atmósfera del clásico de 2001 a plataformas modernas con gráficos, diseño de sonido y jugabilidad mejorados. Se mantiene fiel a la compleja narrativa que convirtió al original en un título definitorio del género."
        },
        development: {
            en: "The project utilized Unreal Engine 5 to deliver high-fidelity environments and realistic lighting. Sound designer Akira Yamaoka and artist Masahiro Ito returned to ensure the remake preserved the haunting essence of the original Silent Hill while modernizing the over-the-shoulder camera and combat systems.",
            es: "El proyecto utilizó Unreal Engine 5 para ofrecer entornos de alta fidelidad e iluminación realista. El diseñador de sonido Akira Yamaoka y el artista Masahiro Ito regresaron para asegurar que el remake preservara la esencia inquietante del Silent Hill original, modernizando la cámara sobre el hombro y los sistemas de combate."
        },
        companyId: "konami"
    },
    {
